      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-20 lg:px-24 py-12 bg-white">
        <div className="max-w-[400px] w-full mx-auto">
          ...
          <div className="flex items-center gap-4 mt-8">
            <button className="w-12 h-12 rounded-full border border-[#E8E8E8] flex items-center justify-center hover:bg-[#F5F5F5] transition-colors">
            ...
            <button className="w-12 h-12 rounded-full border border-[#E8E8E8] flex items-center justify-center hover:bg-[#F5F5F5] transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#060912">
